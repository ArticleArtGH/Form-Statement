...
namespace Statement
{
    public partial class Form1 : Form
    {
        ...
        private void button_ReadFile_Click(object sender, EventArgs e)
        {
            ...
            string path = Application.StartupPath + @"table_Statement.txt", str;
            Encoding encoding = Encoding.GetEncoding(8);/*Encoding.GetEncoding("utf-8"); Encoding.GetEncoding(1251);
